...
function Fantasy(){
    ...
    const [page, setPage] = useState (1)
        useEffect(() =>{
            async function getData(){
                const res = await fetch ('https://api.themoviedb.org/3/discover/movie?api_key=50760a302380745ede7e1c3eee6ca282&with_genres=14')
            ...
            async function fetchMovies(){
                const res = await fetch (`https://api.themoviedb.org/3/discover/movie?api_key=50760a302380745ede7e1c3eee6ca282&with_genres=14&page=${page}`);
                const {results} = await res.json()
    ...
    return(
        ...
        <div className='movieDiv'>
            <h1 className='genrePicked'>Fantasy Movies</h1>
